 ...
 * @author raiss
 */
@WebServlet(name = "ClienteWS", urlPatterns = {"/admin/cliente/ClienteWS"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(String.valueOf(acao)){
            ...
            case "edit":
                id = request.getParameter("id");
                dao = new ClienteDAO();
                Cliente obj = dao.buscarPorChavePrimaria(Long.parseLong(id));
...
//              //  passar a listagem para a página
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String msg;
        String dia = request.getParameter("txtData");
        Date datapublicacao = FormataData.formata(dia, "yyyy-MM-dd");
            ...
            if(request.getParameter("txtNome") == null){
                ...
                if(request.getParameter("txtId")!= null){
                    ...
                    obj.setDatanasc(datapublicacao);

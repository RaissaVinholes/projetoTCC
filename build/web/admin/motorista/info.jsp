...
<!-- FORMA PARA MOSTRAR AS INFORMAÇÕES DOS MOTORISTAS-->
<div class="content">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
    <div class="card-header">
        ...
        <h5 class="title">Informações do Motorista </h5>
     ...
     <div class="card-body">
        ...
        <div class="row">
                <div class="col-md-7 pr-md-1"> <!--class="col-md-5 pr-md-1"-->
                    <div class="form-group">
                        <label>Renach</label>
                        <input type="text" name="txtRenach" required class="form-control" readonly >
                    </div>
                </div>
            </div>
             <div class="row">
